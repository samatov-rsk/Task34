...
public class RestAdminControllerTest extends BaseWeb {
    ...
    public void testAddUserNonUniqueEmail() throws Exception {
        var roles = List.of(new Role(1, "ROLE_USER"));
        var user = new User(1, "user", "userov", 20, "existing_user@mail.ru", "test", roles);
    ...
    public void testUpdateUserById() throws Exception {
        ...
        when(userService.updateUserById(anyInt(), any())).thenReturn(user);
    ...
    public void testUpdateUserNotFound() throws Exception {
        ...
        when(userService.updateUserById(anyInt(), any())).thenThrow(new UserNotFoundException("User not found"));
    ...
    public void testDeleteUserByIdNotFound() throws Exception {
        doThrow(new UserNotFoundException("User not found")).when(userService).removeUser(anyInt());
